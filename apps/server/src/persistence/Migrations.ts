...
import Migration0020 from "./Migrations/019_ReviewComments.ts";
import Migration0021 from "./Migrations/020_ReviewRequests.ts";
...
export const migrationEntries = [
  ...
  [20, "ReviewComments", Migration0020],
  [21, "ReviewRequests", Migration0021],
] as const;
