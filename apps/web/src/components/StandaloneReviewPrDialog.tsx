...
export default function StandaloneReviewPrDialog({
  ...
  const handleResolve = useCallback(async () => {
    ...
    try {
      ...
      // Set upstream tracking so the review branch is linked to the PR's head branch.
      // This enables git status to show PR info and the "Open PR" button.
      try {
        ...
        // Best-effort — review still works without upstream tracking
      }
