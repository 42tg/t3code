              ...
              <div className="min-w-0 px-1 py-0.5">
                {row.message.thinkingText && (
                  <details className="group/thinking mb-3 rounded-lg border border-border/50 bg-muted/20">
                    <summary className="flex cursor-pointer select-none items-center gap-2 px-3 py-2 text-xs text-muted-foreground/70 transition-colors hover:text-muted-foreground/90">
                      <BrainIcon
                        className={`size-3.5 shrink-0 ${row.message.streaming && !row.message.text ? "animate-pulse text-purple-400" : ""}`}
                      />
