...
export default function DiffPanel({ mode = "inline" }: DiffPanelProps) {
  ...
  const defaultBranchQuery = useQuery(gitDefaultBranchQueryOptions(activeCwd ?? null));
  const defaultBranchName = defaultBranchQuery.data ?? null;
