...
export const ReviewRequestUpsertInput = Schema.Struct({
  prUrl: Schema.String,
  prNumber: PositiveInt,
  prTitle: TrimmedNonEmptyString,
  repoNameWithOwner: TrimmedNonEmptyString,
...
export type ReviewRequestUpsertInput = typeof ReviewRequestUpsertInput.Type;
...
export class ReviewRequestError extends Schema.TaggedErrorClass<ReviewRequestError>()(
  "ReviewRequestError",
  {
...
export const ReviewRequestUpsertResult = Schema.Struct({
  reviewRequest: ReviewRequest,
});
export type ReviewRequestUpsertResult = typeof ReviewRequestUpsertResult.Type;
